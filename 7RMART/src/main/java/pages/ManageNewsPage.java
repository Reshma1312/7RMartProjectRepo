...
public class ManageNewsPage {
	...
	@FindBy(xpath = "//a[text() =' Search']") WebElement manageNewsSearch;
	//@FindBy(class = "form-control") WebElement manageNewsSearchTextField;
	@FindBy(xpath = "//input[@placeholder='Title']") WebElement manageNewsSearchField;
	@FindBy(xpath = "//button[text()='Search']") WebElement manageNewsSearchBtn;
	@FindBy(xpath = "//td[text()='News']") WebElement newslist;
	@FindBy(xpath = "//a[text()='Next']") WebElement paginateNext;
	@FindBy(xpath = "./td[2]//a[contains(@href,'edit')]") WebElement editBtn;
	@FindBy(xpath ="./td[1]") WebElement searchData;
